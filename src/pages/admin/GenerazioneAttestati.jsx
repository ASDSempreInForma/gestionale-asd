...
//
// Nuova pagina admin: "Attestati".
// Flusso:
//  1. Cerchi il socio (per cognome o CF), scegli un'iscrizione per pre-compilare i dati
//     (nome corso, importo, periodo) — tutti i campi restano modificabili prima di generare.
//  2. "Genera e scarica PDF" salva una bozza nel database e scarica il PDF vuoto da firmare.
//  3. Lo stampi, lo firmi a mano.
//  4. Con "Carica firmato" alleghi la scansione/foto del documento firmato: da quel momento
//     compare nell'Area Tesserati della persona, che lo scarica in autonomia.
//
  ...
  return (
    <div style={{ maxWidth: 900, margin: '0 auto', padding: 20 }}>
      ...
      <p style={{ color: '#666', marginTop: 0 }}>
        Genera l'attestato pre-compilato, stampalo, firmalo a mano, poi carica qui la copia firmata:
        comparirà automaticamente nell'Area Tesserati della persona.
      </p>
        ...
        {socioSelezionato && (
          <>
            ...
            <button onClick={generaEScarica} disabled={caricamento}
              style={{ marginTop: 8, padding: '10px 20px', borderRadius: 6, border: 'none', background: '#c0392b', color: '#fff', fontWeight: 'bold' }}>
              {caricamento ? 'Generazione in corso...' : '📄 Genera e scarica PDF da firmare'}
            </button>
          </>
        )}
      </div>
            ...
            <tr key={riga.id} style={{ borderBottom: '1px solid #eee' }}>
              ...
              <td style={{ padding: 8 }}>
                {riga.stato === 'disponibile'
                  ...
                  : <span style={{ color: '#b7791f', fontWeight: 'bold' }}>⏳ Bozza — in attesa di firma</span>}
              </td>
              <td style={{ padding: 8 }}>
